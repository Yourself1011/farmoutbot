...
async def daily(message, client):
	...
	if thing == 1:
		...
		await message.channel.send(f'On the way over to claim your daily coins, you accidentally slipped on a slippery {thing2} and died. you paid 100 coins to be reborn.')
		a = db['members']
