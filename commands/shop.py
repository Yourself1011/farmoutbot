...
async def shop(message, client):
    ...
    if thing == 1:
        ...
        await message.channel.send(
            f"On the way over to see the shop, you accidentally slipped on a slippery {thing2} and died. you paid 100 coins to be reborn."
        )
        a = db["members"]
    ...
    if thing == "1":
        thing = "2"
    e.set_footer(
        text=f"Use <{prefix} shop {args[2].lower()} {thing}> to see the next page of {args[2].lower()}."
    )
